...
import com.zph.commerce.fragment.MailOrderFrament;
...
public class MailOrderActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        topNvgBar.setMyOnClickListener(new TopNvgBar5.MyOnClickListener() {
            ...
            public void onRightClick() {
                openActivity(AfterSaleOrderActivity.class);
            }
        });
    }
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        private String[] titles = {getString(R.string.all_order), getString(R.string.un_deliver_order), getString(R.string.shipped_order), getString(R.string.pingjia)};
