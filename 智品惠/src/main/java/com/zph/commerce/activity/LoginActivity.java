...
import com.zph.commerce.fragment.LoginFragment;
import com.zph.commerce.fragment.RegisterFragment;
...
public class LoginActivity extends FragmentActivity {
    ...
    private void initFragment() {// 点击底部调用
        ...
        LoginFragment shouYeFragment = new LoginFragment();
        RegisterFragment carFragment =new RegisterFragment();
        mViews.add(shouYeFragment);
    ...
    private void setSlidr() {
        ...
        SlidrConfig config = new SlidrConfig.Builder().primaryColor(primary)
                ...
                .touchSize(DimenUtils.dip2px(context, 60)).build();
