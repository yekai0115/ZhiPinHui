package com.zph.commerce.view.flowlayout;
...
public class TagFlowLayout extends FlowLayout
    ...
    private int mSelectedCurrent = -1;//当前选择
    ...
    public interface OnSelectTagListener {
        void onSelectedTag(Integer position);
    }
    ...
    public void setSelectCurrent(int position) {
        mSelectedCurrent = position;
    }
    ...
    public void setOnTagSelectListener(OnSelectTagListener onTagSelectListener) {
        mOnSelectTagListener = onTagSelectListener;
    }
}
